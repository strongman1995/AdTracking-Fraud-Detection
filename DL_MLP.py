...
model.fit(train_df, y_train, batch_size=batch_size, class_weight=class_weight, epochs=2, shuffle=True, verbose=2)
del train_df, y_train; gc.collect()
model.save_weights('submission2.h5')
...
print('Time passed %fs'%(time.time() - t0))
